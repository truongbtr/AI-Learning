...
letterPack({
  ...
  note: "Bài 17: G g, Gi gi. Cặp nhiễu chính là g ↔ gi (gà / già, gỗ / giỗ, gò / giò): cùng vần, khác âm đầu, nên mã là nham_am_dau_viet. 'giò' có âm gi chứ không có âm g.",
  words: [
    Wt("nham_am_dau_viet", "gà", "g", "bò", "già", "cà", "gỗ", "🐔", "con gà", "garden"),
    Wt("nham_am_dau_viet", "già", "gi", "bé", "gà", "bà", "giò", "👴", "cụ già", "garden"),
    Wt("nham_am_dau_viet", "gỗ", "g", "lá", "giỗ", "đỗ", "gà", "🪵", "đồ gỗ", "robot"),
    W("giỏ", "gi", "cá", null, "đỏ", "giá", "🧺", "cái giỏ", "garden"),
    W("gió", "gi", "hè", null, "có", "giá", "🌬️", "cơn gió", "garden"),
    W("giá", "gi", "bò", null, "cá", "giò", "🌱", "giá đỗ", "garden"),
    Wt("nham_am_dau_viet", "gò", "g", "kể", "giò", "cò", "gà", null, null),
    W("gụ", "g", "hổ", null, "cụ", "gõ", null, null),
    Wt("nham_am_dau_viet", "giỗ", "gi", "bé", "gỗ", "đỗ", "giò", null, null),
    W("ga", "g", "lê", null, "ca", "gô", null, null),
    Wt("nham_am_dau_viet", "giò", "gi", "cá", "gò", "cò", "già", null, null),
