...
// ═══════════════════════════════════════════════════════════════════════════════════════════════
{
  ...
  [
    ...
    mcq(p, {
      ...
      model: i === 0,
      hints: ["Teen numbers are 11 to 19.", "10 is one ten and no ones."],
...
// ═══════════════════════════════════════════════════════════════════════════════════════════════
{
  ...
  [
    ...
    mcq(p, {
      ...
      hints: [`${n} is a teen number.`, "A teen number has 1 ten."],
  ...
  mcq(p, {
    ...
    wrong: [["Yes", "chuc_khong_du_10"]],
    targets: "chuc_khong_du_10",
    hints: ["Count every cube in the rod.", "A ten needs 10."],
...
// ═══════════════════════════════════════════════════════════════════════════════════════════════
{
  ...
  mcq(p, {
    ...
    model: true,
    hints: ["12 has a ten. 8 does not.", "A ten makes it bigger."],
...
extend("NBT.NUMBER_LINE_TO_20", "emath-mn1-line", [U(3, 4), U(3, 8)], (p) => {
  ...
  mcq(p, {
    ...
    hints: ["The number to the right is greater.", "17 is to the right of 13."],
...
extend("OA.COUNT_ON", "emath-mn1-counton", [U(4, 3)], (p) => {
  ...
  mcq(p, {
    ...
    targets: "dem_thua_1",
    model: true,
    hints: ["Do not count the 6.", "Say 7, 8, 9."],
